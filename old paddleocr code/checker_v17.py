# ==========================================
# MASSIVE-CPU OPTIMIZED PADDLEOCR REDACTOR
# FULL VERSION WITH DEBUG TIMERS
# WINDOWS + EPYC SAFE
# ==========================================

# ==========================================
# ENV OPTIMIZATIONS (MUST BE FIRST)
# ==========================================
import os
...
def create_ocr():
    ...
    print("Creating OCR Engine...", flush=True)
...
def main():
    ...
    try:
        ...
        print(
            ...
            f"{logical_cores} logical threads"
        )
    ...
    print(f"📌 Recommended OCR workers: {recommended}")

    worker_input = input(
        f"\nHow many workers? "
        f"(1-{logical_cores}) "
        f"[default={recommended}]: "
    )
    ...
    worker_count = max(
        1,
        min(worker_count, logical_cores)
    )

    print(f"\n🚀 Starting {worker_count} OCR workers...")
...
if __name__ == "__main__":
    ...
    # REQUIRED FOR WINDOWS + PADDLEOCR
