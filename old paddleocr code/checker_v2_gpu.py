...
def worker_process(
    ...
    # IMPORTANT:
    # each worker gets own OCR model
    ocr = create_ocr()
    ...
    with open(worker_log_path, "w", encoding="utf-8") as log_file:
        ...
        for idx, frame_path in enumerate(frame_files):
            ...
            print("OCR:", round(time.time() - t0, 2), "sec")
            ...
            print("DEDUP:", round(time.time() - t0, 2), "sec")
            ...
            print("DRAW:", round(time.time() - t0, 2), "sec")
            ...
            #print("LOGO:", round(time.time() - t0, 2), "sec")
            ...
            print("SAVE:", round(time.time() - t0, 2), "sec")
...
def main():
    ...
    print("\n⚠️ GPU mode enabled.")
    print("Recommended workers for GPU: 1-2")
    print("Too many workers can SLOW DOWN GPU OCR.\n")

    worker_count = input(
        "How many workers do you want to run? (1-2 recommended): "
    )
    ...
    for worker_id in range(worker_count):
        ...
        worker_frames = list(split_frames[worker_id])
